...
; This file was generated Mon Oct 24 13:05:07 2011
;--------------------------------------------------------
	.module main
...
;------------------------------------------------------------
	G$get_digit$0$0 ==.
	C$main.c$84$1$1 ==.
;	main.c:84: unsigned char get_digit(unsigned int value, unsigned char place) {
;	-----------------------------------------
;	 function get_digit
;	-----------------------------------------
_get_digit:
...
;------------------------------------------------------------
	G$display$0$0 ==.
	C$main.c$93$1$1 ==.
;	main.c:93: void display(unsigned int value) {
;	-----------------------------------------
;	 function display
;	-----------------------------------------
_display:
	...
	mov	r3,dph
	C$main.c$96$1$1 ==.
;	main.c:96: write_segment(2, get_digit(value, 3));
	...
	pop	ar2
	C$main.c$97$1$1 ==.
;	main.c:97: write_segment(1, get_digit(value, 2));
	...
	pop	ar2
	C$main.c$98$1$1 ==.
;	main.c:98: write_segment(0, get_digit(value, 1));
...
;------------------------------------------------------------
	...
	C$main.c$105$1$1 ==.
;	main.c:105: void check_outgoing(){
;	-----------------------------------------
;	 function check_outgoing
;	-----------------------------------------
_check_outgoing:
	C$main.c$107$1$1 ==.
;	main.c:107: if (BUTTON_EXIT == 1) {
	jnb	_P1_1,00105$
	C$main.c$110$2$2 ==.
;	main.c:110: if (free_slots < MAX_SLOTS) {
	mov	r2,_free_slots
	mov	r3,#0x00
	clr	c
	mov	a,r2
...
;------------------------------------------------------------
	...
	C$main.c$119$1$1 ==.
;	main.c:119: void check_incoming() {
;	-----------------------------------------
;	 function check_incoming
;	-----------------------------------------
_check_incoming:
	C$main.c$120$1$1 ==.
;	main.c:120: if (BUTTON_ENTER == 1) {
	jnb	_P1_0,00105$
	C$main.c$122$2$2 ==.
;	main.c:122: if (free_slots > 0) {    
	mov	a,_free_slots
	jz	00105$
	C$main.c$123$3$3 ==.
;	main.c:123: free_slots--;
	dec	_free_slots
00105$:
	C$main.c$126$1$1 ==.
...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$main.c$129$1$1 ==.
;	main.c:129: void main (void) {
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$main.c$130$1$1 ==.
;	main.c:130: init(); // Initialize
	lcall	_init
	C$main.c$133$1$1 ==.
;	main.c:133: while(1) {
00102$:
	C$main.c$134$2$2 ==.
;	main.c:134: display(112); // test OK if 100
	mov	dptr,#0x0070
	lcall	_display
	C$main.c$150$1$1 ==.
;	main.c:150: display(free_slots); // Output the number of free slots
	C$main.c$152$1$1 ==.
	XG$main$0$0 ==.
	sjmp	00102$
	.area CSEG    (CODE)
