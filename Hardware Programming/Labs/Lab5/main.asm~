...
; This file was generated Mon Oct 24 13:25:32 2011
;--------------------------------------------------------
	.module main
...
_init:
	...
	ar1 = 0x01
	C$main.c$38$1$1 ==.
;	main.c:38: MAX_SLOTS = 9; // We have this many free slots, max
	mov	_MAX_SLOTS,#0x09
	clr	a
	mov	(_MAX_SLOTS + 1),a
	C$main.c$40$1$1 ==.
...
;------------------------------------------------------------
	G$get_digit$0$0 ==.
	C$main.c$86$1$1 ==.
;	main.c:86: unsigned char get_digit(unsigned int value, unsigned char place) {
;	-----------------------------------------
;	 function get_digit
;	-----------------------------------------
_get_digit:
	C$main.c$88$1$1 ==.
;	main.c:88: if (place == 0) {
...
;------------------------------------------------------------
	...
	C$main.c$116$1$1 ==.
;	main.c:116: void check_outgoing(){
;	-----------------------------------------
;	 function check_outgoing
;	-----------------------------------------
_check_outgoing:
	C$main.c$118$1$1 ==.
;	main.c:118: if (BUTTON_EXIT == 1) {
	jnb	_P1_1,00105$
	C$main.c$121$2$2 ==.
;	main.c:121: if (free_slots < MAX_SLOTS) {
	mov	r2,_free_slots
	mov	r3,#0x00
	clr	c
	mov	a,r2
...
;------------------------------------------------------------
	...
	C$main.c$130$1$1 ==.
;	main.c:130: void check_incoming() {
;	-----------------------------------------
;	 function check_incoming
;	-----------------------------------------
_check_incoming:
	C$main.c$131$1$1 ==.
;	main.c:131: if (BUTTON_ENTER == 1) {
	jnb	_P1_0,00105$
	C$main.c$133$2$2 ==.
;	main.c:133: if (free_slots > 0) {    
	mov	a,_free_slots
	jz	00105$
	C$main.c$134$3$3 ==.
;	main.c:134: free_slots--;
	dec	_free_slots
00105$:
	C$main.c$137$1$1 ==.
...
_main:
	C$main.c$141$1$1 ==.
;	main.c:141: init(); // Initialize
	lcall	_init
	C$main.c$143$1$1 ==.
;	main.c:143: while (1) {
00102$:
	C$main.c$145$2$2 ==.
;	main.c:145: check_incoming(); // Car enters
	lcall	_check_incoming
	C$main.c$147$2$2 ==.
;	main.c:147: check_outgoing(); // Car leaves
	lcall	_check_outgoing
	C$main.c$154$2$2 ==.
;	main.c:154: for (cycle_delay = 0; cycle_delay < cycle_duration; cycle_delay++);
	clr	a
	mov	_cycle_delay,a
...
00107$:
	C$main.c$156$2$2 ==.
;	main.c:156: display(free_slots); // Output the number of free slots
	mov	r2,_free_slots
	mov	r3,#0x00
	mov	dpl,r2
	mov	dph,r3
