...
;------------------------------------------------------------
	G$display$0$0 ==.
	C$main.c$109$1$1 ==.
;	main.c:109: void display(unsigned int value) {
;	-----------------------------------------
;	 function display
;	-----------------------------------------
_display:
	...
	mov	r3,dph
	C$main.c$114$1$1 ==.
;	main.c:114: for (i = 0; i < NUMBER_OF_DIGITS; i++) {
	mov	r4,#0x00
00101$:
	clr	c
	mov	a,r4
	...
	jnc	00105$
	C$main.c$115$2$2 ==.
;	main.c:115: write_segment(i, get_digit(value, i));
...
;------------------------------------------------------------
	...
	C$main.c$123$1$1 ==.
;	main.c:123: void check_outgoing(){
;	-----------------------------------------
...
;------------------------------------------------------------
	...
	C$main.c$137$1$1 ==.
;	main.c:137: void check_incoming() {
;	-----------------------------------------
;	 function check_incoming
;	-----------------------------------------
_check_incoming:
	C$main.c$138$1$1 ==.
;	main.c:138: if (BUTTON_ENTER == 1) {
	jnb	_P1_0,00105$
	C$main.c$140$2$2 ==.
;	main.c:140: if (free_slots > 0) {    
	mov	a,_free_slots
	orl	a,(_free_slots + 1)
	jz	00105$
	C$main.c$141$3$3 ==.
;	main.c:141: free_slots--;
	dec	_free_slots
	mov	a,#0xff
	cjne	a,_free_slots,00111$
	dec	(_free_slots + 1)
...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$main.c$147$1$1 ==.
;	main.c:147: void main (void) {
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$main.c$148$1$1 ==.
;	main.c:148: init(); // Initialize
	lcall	_init
	C$main.c$150$1$1 ==.
;	main.c:150: while (1) {
00102$:
	C$main.c$152$2$2 ==.
;	main.c:152: check_incoming(); // Car enters
	lcall	_check_incoming
	C$main.c$154$2$2 ==.
;	main.c:154: check_outgoing(); // Car leaves
	lcall	_check_outgoing
	C$main.c$161$2$2 ==.
;	main.c:161: for (cycle_delay = 0; cycle_delay < cycle_duration; cycle_delay++);
	clr	a
	mov	_cycle_delay,a
...
00107$:
	C$main.c$163$2$2 ==.
;	main.c:163: display(free_slots); // Output the number of free slots
	mov	dpl,_free_slots
