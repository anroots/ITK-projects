...
F:G$check_start_press$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$init$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$set_time$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$start$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$stop$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$process_key_press$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$convert_seconds$0$0({2}DF,SI:U),C,0,0,0,0,0
...
S:G$BUTTON_START$0$0({1}SC:U),E,0,0
S:G$BUTTON_ERROR$0$0({1}SC:U),E,0,0
S:G$seconds_left$0$0({2}SI:S),E,0,0
S:LGetNumberFromMatrixKeypad$col$1$1({1}SC:U),R,0,0,[r2]
S:LGetNumberFromMatrixKeypad$row$1$1({1}SC:U),R,0,0,[r3]
...
S:Lset_time$digit$1$1({1}SC:U),R,0,0,[r2]
S:Lprocess_key_press$pressed_key$1$1({1}SC:U),R,0,0,[r2]
S:Lconvert_seconds$seconds$1$1({2}SI:S),R,0,0,[r2,r3]
...
S:G$check_start_press$0$0({2}DF,SV:S),C,0,0
S:G$init$0$0({2}DF,SV:S),C,0,0
S:G$set_time$0$0({2}DF,SV:S),C,0,0
S:G$start$0$0({2}DF,SV:S),C,0,0
S:G$stop$0$0({2}DF,SV:S),C,0,0
S:G$process_key_press$0$0({2}DF,SV:S),C,0,0
S:G$convert_seconds$0$0({2}DF,SI:U),C,0,0
